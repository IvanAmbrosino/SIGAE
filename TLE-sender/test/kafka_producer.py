...
class GeneradorTle():
    ...
    def conect_kafka_producer(self):
        """Conexion con kafka"""
        conf = {
        'bootstrap.servers': 'localhost:29092,localhost:29093,localhost:29094',  # Brokers de Kafka
...
if __name__ == "__main__":
    ...
    import random
    random.randint(0,9)
    with open('/home/iambrosino/viasat-tle-sender/src/configs/list_satellites.config', 'r',encoding='utf-8') as file:
    ...
    for norad_id in norad_ids:
        gtle.kafka_producer(norad_id, tles[i])
        break
        # sleep(10)
